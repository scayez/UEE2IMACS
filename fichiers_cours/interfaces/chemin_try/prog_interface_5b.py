...
try:
    qtCreatorFile = "fichiers_cours/interfaces/mon_interface5.ui" # Essayer d'ouvrir ce fichier.
    with open(qtCreatorFile):
        pass  # Si le fichier existe, ne rien faire.
except FileNotFoundError:
    qtCreatorFile = "mon_interface5.ui"  # Si le fichier n'existe pas, utiliser un chemin de secours.
