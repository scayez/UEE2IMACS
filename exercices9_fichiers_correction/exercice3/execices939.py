# 9- ajouter une fonction compter_points qui remplit un tableau numpy avec 2 colonne (1 pour le joueur, 1 pour le programme) à chaque 
# tour r on ajoutera une ligne avec 1 pour le gagnant 0 pour le perdant
#Utiliser une variable self.vainqueur qui prendra la valeur 'programme 'ou 'joueur'. Cette variable sera modifiée en remplacement des print dans la fonction verif gagnant, 
# apres sa modification la fonction compter_points sera appelée.
# On stockera les scores des joueurs dans un tableau de 2 colonnes appelé self.score auquel on ajoutera des lignes à chaque visctoire du joueur ou du programme.
...
qtCreatorFile = os.path.join(base_dir, "exercice9_3.ui")
...
class MyWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def compter_points(self): #<===========
        ...
        if self.vainqueur == 'programme':#<===========
            ...
            self.afficher_message('Programme gagne', '1 point programme')#<===========
            self.score = np.append(self.score , [[0, 1]], axis=0)#<===========
            print(self.score)    #<===========  
