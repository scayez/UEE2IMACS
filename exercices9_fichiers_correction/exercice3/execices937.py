# 7- Ecrire une fonction verif_gagnant pour vérifier qui est le gagnant. On utilisera les 
# fonctions de Numpy np.all np.diag et np.fliplr pour verifier si le joueur ou le programme a fait une ligne
# une colonne ou une diagonale
# on appelera cette fonction après le tour du joueur.
